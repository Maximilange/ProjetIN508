...
class FenetrePrincipale : public QMainWindow
{
                ...
                QTabWidget* widgetOnglet;
                    ...
                    QWidget* ongletArbre;
                        QVBoxLayout* layoutArbre;
                            ...
                            QWidget* verifArbre;
                                QGridLayout* verifArbreLayout;
                                    QLabel* titreVerifArbre;
                                    QLineEdit* cheminVerifArbre;
                                    QPushButton* parcourirVerifArbre;
                                    QPushButton* lancerVerifArbre;
    // Constructeur
    public :
        FenetrePrincipale();
    ...
    public slots :
        ...
        // Changement de couleur dù à des erreurs dans les deux onglets
            ...
            void coulErreurCheminVerifTexte();
